...
def configure_moviepy_all(temp_dir="/app/tmp", ffmpeg_path=None, imagemagick_path=None, disable_progress_bar=False):
    """
    ...
    Args:
        ...
        imagemagick_path (str): Path to the ImageMagick binary
        disable_progress_bar (bool): Whether to disable MoviePy progress bar
    ...
    if disable_progress_bar:
        ...
        print("MoviePy progress bar disabled")
