...
def create_caption_clip(text, video_size, duration, font_size=40, template="minimal_white", current_word=None, current_word_color=None, is_profane=False, custom_text_color=None, custom_highlight_color=None, custom_font=None):
    ...
    Classic/Minimal:
        ...
        - "elegant_pink": Elegant Pink (Anton, White with TikTok-style Highlights)
    ...
    highlight_colors = {
        ...
        "elegant_pink": (255, 63, 51, 230),  # TikTok red with transparency (#FF3F33)
    ...
    for line_idx, line in enumerate(lines):
        ...
        for word_idx, word in enumerate(words):
            ...
            # For Elegant Pink template, draw a TikTok-style highlight bar behind keywords
            elif template.lower() == "elegant_pink" and is_highlighted:
                # Draw a highlight bar behind the word
                highlight_padding = int(font_size * 0.1)  # Padding around the text
                
                # Get the highlight color for Elegant Pink - TikTok red
                highlight_color = highlight_colors.get("elegant_pink", (255, 63, 51, 230))  # TikTok red (#FF3F33)
                ...
                # Text remains the normal color for elegant_pink
...
def get_templates():
    ...
    templates = [
        ...
        },
        {
            ...
            "category": "Classic/Minimal",
            "color": "#FF3F33",
            "description": "White text with TikTok-style red highlights",
