    ...
    try:
        ...
        if USE_R2_STORAGE and r2_client:
            ...
            try:
                ...
                final_video_url = f'/processed/{output_filename}'
                final_transcription_url = f'/api/transcription/{transcription_filename}'
                final_original_video_url = f'/processed/{original_video_filename}'
        else:
