...
def api_process():
    ...
    try:
        ...
        duration_message = f"Video processing finished in {processing_duration:.2f} seconds."
        print(duration_message)
        log_api_debug(duration_message)
        ...
        if 'processing_start_time' in locals():
            processing_duration = time.time() - processing_start_time
            log_error(f"Processing failed after {processing_duration:.2f} seconds.")
